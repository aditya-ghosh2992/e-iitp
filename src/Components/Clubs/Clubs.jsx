...
import clubImage1 from '../../assets/gallery-2.png'; 
import clubImage2 from '../../assets/gallery-4.jpg'; 
...
const Clubs = () => {
  const clubs = [
    ...
    { id: 4, name: 'Entrepeneur Club', description: 'Celebrate diversity through events, festivals, and performances. Join us to explore and appreciate various cultural traditions and heritages.', image: clubImage3 },
